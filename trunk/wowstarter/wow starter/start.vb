...
Public Class start
    ...
    Private Sub AccountvewaltungToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AccountvewaltungToolStripMenuItem.Click
        Form1.Show()
    End Sub
    Private Sub mysqlladen()
        If File.Exists("MySql.Data.dll") Then

        Else
            My.Computer.Network.DownloadFile("http://mcivory.mc.funpic.de/launcher/MySql.Data.dll", "MySql.Data.dll")
        End If
    End Sub
End Class